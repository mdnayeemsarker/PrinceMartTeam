...
public class ManProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Team Manager Profile");
        }
        ...
        if (ApiConfig.isConnected(activity)) {
            findViewById(R.id.withdrawId).setOnClickListener(v -> {
                startActivity(new Intent(activity, ManWithdrawActivity.class));
                finish();
            });
            getDate();
        }
