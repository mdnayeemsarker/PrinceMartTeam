...
public class ManWithDashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man_with_dash);
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("Team Manager Withdraw Dashboard");
        }
