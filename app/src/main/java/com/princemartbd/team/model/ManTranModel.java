...
public class ManTranModel {
    ...
    public ManTranModel(String id, String paid_to, String paid_from, String trx_type, String trx, String amount, String post_balance, String status, String date_created, String last_updated) {
        this.id = id;
